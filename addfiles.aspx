<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addfiles.aspx.cs" Inherits="addfiles" %>
   ...
   <link href="https://cdnjs.cloudflare.com/ajax/libs/jquery-footable/0.1.0/css/footable.min.css"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function deactivate(id1) {
            location.href = 'activateusers.aspx?id1=' + id1;
        }
</script>
</head>
<body data-spy="scroll" data-target="#main-navbar">
    ...
    <div class='preloader'><div class='loaded'>&nbsp;</div></div>
            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <asp:Label ID="Label5" runat="server" Text="Smart File Activity Anomaly Detection" Font-Size=XX-Large></asp:Label>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
            </nav>
        </div>
        ...
        <section id="works-area" class="sections">
            ...
            <asp:Label ID="Label1" runat="server" Text="Add Files" Font-Bold="True" 
                    Font-Names="Arial" Font-Size="13px" style=" text-align:justify" ></asp:Label>&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/adminviewfiles.aspx">View Files</asp:HyperLink>
                    <div class="EU_TableScroll" id="showData" style="display: block">
                    <table style="line-height:15px; width:369px;" CssClass="EU_DataTable">
                    ...
                    <tr>
                    <td>
                    <asp:Label ID="Label3" runat="server" Text="Select A File"></asp:Label>
                    </td>
                    <td>
                    <asp:FileUpload ID="FileUpload1" runat="server" Width="227px"></asp:FileUpload>
                    </td>
                    </tr>
